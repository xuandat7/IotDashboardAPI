...
import { getSensorDataController } from './controller/sensor.controller';
...
@Module({
  ...
  controllers: [DevicesController, GetDataActionController, getSensorDataController, MqttController, DeviceStatusController],
})
