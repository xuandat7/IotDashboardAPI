...
import { DeviceDataController } from './controller/getdata.controller';
...
@Module({
  ...
  controllers: [DevicesController, DeviceDataController, SensorDataController, MqttController, DeviceStatusController],
})
